    ...
    <section className="bg-white pb-48 dark:bg-gray-900">
      <div className=" max-w-screen-xl px-4 mx-auto ">
          <div className="flex items-center flex-wrap gap-14">
              ...
              <div className="basis-80 flex-grow">
                  <h2 className="text-4xl font-bold mb-8">Have access to a robust email marketing tool.</h2>
                  <p className="text-gray-500 mb-8">If you’re reading this, you already have access to a robust email marketing tool.</p>
